                        ...
                        <div class="col-md-6">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <label class="form-control" for="marital_status">Marital Status: 
										<select name="marital_status" id="marital_status" class="form-select" onkeyup="change(this.id,'errmarital_status','data')" onblur="change(this.id,'errmarital_status','data')" >
