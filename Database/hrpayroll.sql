...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1308648005ltr&server=1">
...
<body>
    <div id="pma_navigation" data-config-navigation-width="164">
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=hrpayroll&table=attendance">`hrpayroll`.`attendance`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=hrpayroll&table=employee">`hrpayroll`.`employee`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=hrpayroll&table=company">`hrpayroll`.`company`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=hrpayroll&table=user_table">`hrpayroll`.`user_table`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=hrpayroll&table=districts">`hrpayroll`.`districts`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=hrpayroll&table=attendance_schedule">`hrpayroll`.`attendance_schedule`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=hrpayroll&table=payroll">`hrpayroll`.`payroll`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=hrpayroll&table=user_role">`hrpayroll`.`user_role`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=hrpayroll&table=salary">`hrpayroll`.`salary`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=hrpayroll&table=salary_setup">`hrpayroll`.`salary_setup`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="337e40627b7c4f2d4778576236635b60">
...
</span><small>Set to 0 to collapse navigation panel.</small></th><td><input type="number" name="NavigationWidth" id="NavigationWidth" class="custom" value="164"><a class="restore-default hide" href="#NavigationWidth" title="Restore default value"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a></td></tr></table>
</fieldset>
