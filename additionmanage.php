				...
				<div class="forms-body">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<h3 style="margin:10px;">Manage Addition</h3>
					...
					<div class="">
						<div class="row">
							...
							<div class="col-offset-md-2"><a href="Addition.php" class="btn btn-primary bx-pull-right mb-3">Add Addition</a></div>
									...
									<div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
										<table class="table table-bordered">
											...
											<tr>
												...
												<td><?php echo $row['addition_code'] ?></td>
												<td> <?php echo $row['description'] ?></td>
												<td> <?php echo $row['amount'] ?></td>
												<td> <?php echo $row['month'].", ".$row['addition_year'] ?></td>
												...
												<td>
													<?php
														...
														if($row['addition_status'] == "Approved") {
															
															$status = "<span class=' btn-success'> Approved </span>";
														
														}else if($row['addition_status'] == "declined") {
												...
												<td>
													...
													?>
														<a class="btn btn-danger" href="deleteaddition.php?aid=<?php echo $row[0];?>">Delete</a>
														<a class="btn btn-success" href="updateaddition.php?id=<?php echo $row[0];?>">Update</a>
